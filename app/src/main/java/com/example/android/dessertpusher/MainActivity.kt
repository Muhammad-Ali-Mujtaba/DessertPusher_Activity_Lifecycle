...
class MainActivity : AppCompatActivity(), LifecycleObserver {
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        Timber.i("called in onSaveInstanceState()")
    ...
    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        ...
        Timber.i("called in onRestoreInstanceState()")
    }

    override fun onStart() {
        super.onStart()
        Timber.i("called in onStart()")
    }

    override fun onStop() {
        super.onStop()
        Timber.i("called in onStop()")
    }

    override fun onRestart() {
        super.onRestart()
        Timber.i("called in onRestart()")
    }

    override fun onPause() {
        super.onPause()
        Timber.i("called in onPause()")
    }

    override fun onResume() {
        super.onResume()
        Timber.i("called in onResume()")
    }

    override fun onDestroy() {
        super.onDestroy()
        Timber.i("called in onDestroy()")
    }
}
